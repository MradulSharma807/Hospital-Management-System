...
<body style="background-image:url(image17.jpg);">
        
        <form action="viewdoctor.php" method="POST">
		    <div class="div2">
			
			<h1><img src="1.png"></h1>
			<span><h1 id="head"><u>Search Doctor by:</u></h1></span>
            <label for ="data" style="font-size:23px;color:black;margin-left:500px;"><b>Enter Your Data/Word Here :</b></label>
      ...
      <!-- populate table from mysql database -->
		...
		<td style="center"><a href="updatedoctor.php?fname=<?php echo $row["fname"];?>" style="color:blue;font-family:arial;"><blink><b>Edit / Update</b></blink></a></td>
		<td style=""><a href="deletedoctor.php?un=<?php echo $row["fname"]; ?>" style="color:red;font-family:arial;"><blink><b>Delete</b></blink></td>
