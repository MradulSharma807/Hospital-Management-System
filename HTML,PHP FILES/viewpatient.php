...
if(isset($_POST['search']))
{
  ...
  $query = "SELECT * FROM adddoctor WHERE  CONCAT(`fname`,`lname`,`Contact`,`Age`,`address`,`caste`,`gender`,`Admitdate`,`Date Of Birth`,`Disease`) LIKE '%".$valueToSearch."%'";
...
<body style="background-image:url(image29.jpg);">
        
        <form action="viewpatient.php" method="POST">
		    <div class="div2">
			
			<h1><img src="1.png"></h1>
			<span><h1 id="head" style="color:white;"><u>Search Patient by:</u></h1></span>
            <label for ="data" style="font-size:23px;color:white;margin-left:500px;"><b>Enter Your Data/Word Here :</b></label>
      ...
      <!-- populate table from mysql database -->
		...
		<td align="center"><b><?php echo$row['Disease'];?><b></td>
		<td style="center"><a href="updatepatient.php?fname=<?php echo $row["fname"];?>" style="color:blue;font-family:arial;"><blink><b>Edit / Update</b></blink></a></td>
		<td style=""><a href="deletepatient.php?un=<?php echo $row["fname"]; ?>" style="color:red;font-family:arial;"><blink><b>Delete</b></blink></td>
